...
def main(csrf_token, leetcode_session):
    ...
    # leetcode._fetch_and_store_problem('edit-distance')

    plans = ["top-interview-150", "leetcode-75"]
    for plan in plans:
...
if __name__ == "__main__":
    ...
    main(os.getenv("CSRF_TOKEN"), os.getenv("LEETCODE_SESSION"))
